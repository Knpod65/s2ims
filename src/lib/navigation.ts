...
export const NAV_CONFIG: Record<Role, NavItem[]> = {
  student: [
    ...
    { label_th: 'บันทึกชั่วโมงทุน', label_en: 'Work-Study Hours', href: '/student/work-study', icon: 'ClipboardList' },
  ...
  staff: [
    ...
    { label_th: 'ทุนการศึกษา', label_en: 'Scholarships', href: '/staff/scholarships', icon: 'BookOpen' },
    ...
    { label_th: 'ตรวจชั่วโมงทุน', label_en: 'Work-Study Review', href: '/staff/work-study/approvals', icon: 'ClipboardList' },
  ...
  esq: [
    ...
    { label_th: 'กำกับคุณภาพทุน', label_en: 'Scholarship Oversight', href: '/esq/scholarships', icon: 'BookOpen' },
  ...
  provider: [
    ...
    { label_th: 'พอร์ตทุน', label_en: 'Scholarship Portfolio', href: '/provider/scholarships', icon: 'BookOpen' },
  ...
  admin: [
    ...
    { label_th: 'ธรรมาภิบาลทุน', label_en: 'Scholarship Governance', href: '/admin/scholarships', icon: 'BookOpen' },
...
export const MOBILE_NAV: Record<Role, NavItem[]> = {
  student: [
    ...
    { label_th: 'ชั่วโมงทุน', label_en: 'Hours', href: '/student/work-study', icon: 'ClipboardList' },
  ...
  staff: NAV_CONFIG.staff,
  esq: NAV_CONFIG.esq,
  provider: NAV_CONFIG.provider,
  admin: NAV_CONFIG.admin,
}
